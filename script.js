// Conversion Français → Gematria Primus
document.getElementById("convert-button").addEventListener("click", () => {
  ...
  // Copier le texte en Gematria Primus
  ...
  // Conversion Gematria Primus → Français
